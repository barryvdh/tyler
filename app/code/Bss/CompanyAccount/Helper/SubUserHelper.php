...
class SubUserHelper
{
     ...
     */
    public function createSubUser($request, $customerId, &$messageErrorEmail = null)
    {
        ...
        $user->setSubUserName($request->getParam(SubUser::NAME));
        $user->setRoleId((int)$request->getParam(SubUser::ROLE_ID));
        $user->setSubUserStatus((int)$request->getParam(SubUser::STATUS));
