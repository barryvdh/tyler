        ...
        if ($this->helper->isEnable()) {
            ...
            try {
                ...
                if ($subUser) {
                    ...
                    $validatedResult = $this->loginPost->validateB2bRegistration($customer);
                    if ($validatedResult) {
                        $response = [
                            'errors' => true,
                    ...
                    if ($isAuthenticated && !$subUser->getSubUserStatus()) {
                        $response = [
                            'errors' => true,
                            'message' => __('Your account is inactive. Please contact your company account for more details.')
                        ];
                    }
                    if ($isAuthenticated && $subUser->getSubUserStatus()) {
