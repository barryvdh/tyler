...
/**
 * Class FinalPriceBox
 * @package Bss\ProductStockAlert\Plugin\Pricing\Render
 */
class FinalPriceBox
{
    ...
    public function afterToHtml($subject, $result)
    {
        ...
        if ($this->doRenderStock($product)) {
            $button = '<div class="notify_me_bss"><a class="action primary notification_me'. $product->getId() .'" href="'.$product->getProductUrl().'" title="'. $btnText . '" style="background-color: ' . $btnColor . '"><span style="color: ' . $btnTextColor . '">'. $btnText . '</span></a></div>
