<?php
/**
 * Class for Restrictcustomergroup HideProduct Upsell
...
class Upsell
{
    ...
    )
    {
      ...
      foreach ($upsellprodcollection as $key => $product)
      {
        $ruleProducts = [];
        ...
        if (!empty($collection->getData()))
        {
          foreach ($collection->getData() as $item)
          {
            ...
            {
              $upsellprodcollection->removeItemByKey($key);
            }
            else
            {
